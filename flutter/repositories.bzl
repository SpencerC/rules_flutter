...
flutter_toolchain(
    ...
    flutter_tool = select({
        "@bazel_tools//src/conditions:host_windows": "bin/flutter.bat",
    ...
    runner_template = select({
        "@bazel_tools//src/conditions:host_windows": "@rules_flutter//flutter:runner.bat.template",
