...
def _flutter_repo_impl(repository_ctx):
    ...
    # Note: For development/testing purposes, integrity checking is disabled
    # In production, you would need to provide real Flutter SDK SHA-384 hashes
...
load("@com_github_spencerc_rules_flutter//flutter:toolchain.bzl", "flutter_toolchain")

flutter_toolchain(
    name = "flutter_toolchain",
    target_tool = select({
        "@platforms//os:windows": "flutter/bin/flutter.bat",
