...
def _flutter_repo_impl(repository_ctx):
    url = "https://github.com/someorg/someproject/releases/download/v{0}/flutter-{1}.zip".format(
...
flutter_toolchain(
    ...
    target_tool = select({
        "@bazel_tools//src/conditions:host_windows": "flutter_tool.exe",
        "//conditions:default": "flutter_tool",
    }),
)
"""
