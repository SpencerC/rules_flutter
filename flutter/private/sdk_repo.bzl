...
def _sdk_repo_impl(repository_ctx):
    ...
    _write_root_aliases(repository_ctx, canonical_target_repo, platform)
...
def _write_root_aliases(repository_ctx, canonical_target_repo, platform):
...
alias(
    name = "flutter",
    actual = ":flutter_binary_{suffix}",
    visibility = ["//visibility:public"],
)

alias(
    name = "dart",
    actual = ":dart_binary_{suffix}",
    visibility = ["//visibility:public"],
)
...
""".format(
        ...
        suffix = "windows" if platform == "windows" else "unix",
    )
